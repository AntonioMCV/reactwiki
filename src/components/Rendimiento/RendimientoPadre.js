      ...
      <div className="border border-black p-5 mb-5">
        ...
        <form onSubmit={handleSubmit}>
          <div className="row align-items-end mb-4">
            <div className="col">
                <label className="form-label">Escribe para volver a renderizar el componente padre</label>
                <input className="form-control" type="text" onChange={handleChange} value={keyWord}/>
            </div>
            <div className="col-auto">
              <button className="btn btn-primary">Cambiar el nombre del hijo</button>
            </div>
          </div>
        </form>
