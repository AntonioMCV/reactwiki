  ...
  return (
    <>
      ...
      <p className="alert alert-warning">
        Para poder usar este componente es necesario{" "}
        <b>utilizar la store básica</b>, cambiando en <b>src\index.js</b> la
        linea 16 <b>storeReduxToolkit por storeReduxbasic</b>.
      </p>
      <div className="alert alert-secondary">
        <p>
          Cada componente puede tener su propio estado que cambia con el tiempo,
          por ejemplo, el número de "Me gusta" en una publicación o la
        ...
        <p>
          En resumen, Redux trabaja en conjunto con React para ayudarte a
          manejar el estado de tu aplicación de una manera más organizada y
          predecible. Te brinda una estructura clara para gestionar cambios en
          el estado, lo que es especialmente útil cuando tu aplicación se vuelve
        ...
        <p>
          Como nota importante saber que nuestros Reducers siempre deben
          retornar el objeto entero de nuevo, esto puede llevar a que nuestro
          archivo sea demasiado grande y dificil de mantener es por eso que
          ahora tenemos a nuestra dispoción{" "}
