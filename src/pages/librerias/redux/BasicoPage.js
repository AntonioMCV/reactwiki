import Counter from "components/ReduxCounterBasico/Counter";
  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <b>Acciones (Actions)</b>: Las acciones en Redux son como solicitudes
          para cambiar algo en tu almacén. Por ejemplo, si alguien hace clic en
          un botón "Me gusta", eso genera una "acción" para aumentar el contador
          de "Me gusta". Las acciones son pequeños objetos que describen qué
          sucedió.
        </li>
        <li>
        ...
        <li>
          <b>Despachar (Dispatch)</b>: Es como decirle a Redux que ocurrió algo
          y que debe manejarlo. Por ejemplo, cuando alguien hace clic en un
          botón, puedes "despachar" una acción, que luego será manejada por los
          reductores para actualizar el estado en el almacén.{" "}
        </li>
        <li>
          ...
          serán notificados cada vez que el estado en el almacén cambie. De esta
          manera, puedes actualizar automáticamente la interfaz de usuario para
          que coincida con el estado actual.{" "}
        </li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>
          <b>Usar useSelector, useDispatch</b> de react-redux en los componentes
          donde queramos cambiar el estado de Redux
        </li>
      </ul>
      <p>
