...
const UseEffectPage = () => {
  ...
  return (
    <>
      <h1 className="bg-dark text-white text-center my-4 py-4">useEffect</h1>
      <p className="alert alert-secondary">
        ...
        Esto es solo un ejemplo para ver el funcionamiento del useEffect pero para un caso así sería mas optimo de hacer uso del hook <Link to="/hooks/use-reducer">useReducer</Link>.
      </p>
      <LoginUseEffect />
    </>
  )
