  ...
  return (
    <>
      ...
      <p className="alert alert-secondary">
        <h3 className="mb-4">¿Pero que es React?</h3>
        ...
        <br />
        <br />
        La principal característica de React es su enfoque en la construcción de
        interfaces de usuario mediante la utilización de componentes. Un
        ...
        de acuerdo con las actualizaciones del estado. Esto permite la creación
        de interfaces de usuario modulares y escalables.
        <br />
        <br />
        ...
        <br />
        <br />
        React es muy popular en el desarrollo web moderno y se combina a menudo
        con otras bibliotecas y herramientas para construir aplicaciones
        completas. Para administrar el estado de las aplicaciones en React, se
        pueden usar soluciones como "Redux" o "Mobx". Además, React puede
        integrarse con marcos de trabajo de desarrollo web como "React Router"
        para manejar la navegación y "Axios" para realizar solicitudes HTTP.
        <br />
        <br />
        En resumen, React es una tecnología que permite construir interfaces de
        usuario interactivas y dinámicas en aplicaciones web a través de
        componentes reutilizables y un enfoque eficiente en la manipulación del
        DOM.
      </p>
    </>
  );
