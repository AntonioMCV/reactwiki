  ...
  return (
    <>
      ...
      <p className="alert alert-secondary">
        ...
        Por otro lado tambien en la consola cada vez que hacemos scroll podemos ver como se va actualizando las propiedades del objeto con un monton de información que podremos utilizar segun a nuestras necesidades.
      </p>
      <div style={{ height: '200vh', background : 'red', color: 'white'}}>
